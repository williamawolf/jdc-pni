...
% Load bibliography resources
\addbibresource{jdc_refs.bib} % Filename of the peer-reviewed articles and competitively-reviewed conference papers bibliography
\addbibresource{jdc_books.bib} % Filename of the books bibliography
\addbibresource{jdc_published_abstracts.bib} % Filename of the published abstracts bibliography
\addbibresource{jdc_reviews_commentary_etc.bib} % Filename of the reviews, commentary, technical reports, chapters bibliography
\addbibresource{jdc-under-review-in-prep.bib} % Filename of the under review and in prep bibliography


% OLD: Create a filter that checks which file an entry belongs to
%\DeclareIndexLabelFormat{default}{#1}
%\def\ifentryinbib#1#2#3{%
%  \ifboolexpr{ test {\ifstrequal{\thefield{bibresource}}{#1}} }
%  {#2}{#3}}

% OLD: To enable multiple simultaneously printed bibliography subsections in Publications
...
\begin{refsection}[jdc-under-review-in-prep.bib]
    \nocite{*}
    \printbibliography[heading=none]
\end{refsection}
